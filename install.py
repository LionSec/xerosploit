...
""")
	...
	if system0 == "1":
		...
		install = os.system("apt-get update && apt-get install -y nmap hping3 build-essential python3-pip ruby-dev git libpcap-dev libgmp3-dev && pip install tabulate terminaltables && apt-get install bettercap")
		...
		install = os.system("apt-get update && apt-get install -y nmap hping3 ruby-dev git libpcap-dev libgmp3-dev python-tabulate python-terminaltables && apt-get install bettercap")
