...
""")
	...
	if system0 == "1":
		...
		os.system("apt-get update && apt-get install -y nmap hping3 build-essential python-pip3 ruby-dev git libpcap-dev libgmp3-dev && pip3 install tabulate terminaltables")
		...
		os.system("apt-get remove bettercap") # Remove bettercap to avoid some problems . Installed by default with apt-get .
		os.system("gem install bettercap") # Reinstall bettercap with gem.
		os.system("apt-get update && apt-get install -y nmap hping3 ruby-dev git libpcap-dev libgmp3-dev python-tabulate python-terminaltables")
